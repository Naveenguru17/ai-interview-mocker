...
function AddNewInterview() {
  ...
  const onSubmit=async (e)=>{
    ...
    const InputPrompt="Job position"+jobPosition+"Job Description"+jobDesc+"Years of Experience :"+jobExperience+" Depends on the job position,job descriptioin and years of experience give us" +process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT+ "Provide the output in JSON format, with each object containing 'question' and 'answer' fields only."
